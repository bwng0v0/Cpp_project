...
void CppSTL::countWord() {
    ...
    string next;
    const string& word = UI::getNext("Word to count? "); // 사용자로부터 단어 하나 입력 받음
    ...
    vector<pair<string,int>> wcVector;
...
void CppSTL::run() {
    ...
    func_t func_arr[] = {
        nullptr,&CppSTL::display,&CppSTL::shuffle,&CppSTL::sort,&CppSTL::reverseSort,&CppSTL::reverse,
        &CppSTL::dispMemo,&CppSTL::countWord,&CppSTL::top10WordCount,&CppSTL::copyPersons,
